...
import { Collapse, List, ListItem, ListItemIcon, ListItemText } from '@unified-codes/ui/components';
...
export const Nested = () => {
  ...
  const IconFirst = React.useCallback(() => (isOpenFirst ? <ArrowUpIcon /> : <ArrowDownIcon />), [
    isOpenFirst,
  ]);
  const IconSecond = React.useCallback(() => (isOpenSecond ? <ArrowUpIcon /> : <ArrowDownIcon />), [
    isOpenSecond,
  ]);
