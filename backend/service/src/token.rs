...
pub const DEFAULT_REFRESH_TOKEN_EXPIRY: usize = 60 * 60 * 12; // 12 hours
pub const DEFAULT_TOKEN_EXPIRY: usize = 60 * 60 * 4; // 4 hours
...
mod user_account_test {
    ...
    async fn test_user_auth() {
        ...
        // should be able to create a new token with empty organsiation
