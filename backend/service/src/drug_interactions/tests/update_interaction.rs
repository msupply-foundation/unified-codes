...
mod test {
    ...
    #[actix_rt::test]
    async fn upsert_drug_interaction_errors() {
        let (_, _, connection_manager, _) =
            setup_all("upsert_drug_interaction_errors", MockDataInserts::none()).await;
        ...
        let input = UpsertDrugInteraction {
            interaction_id: new_interaction_id.clone(),
            name: new_interaction_id.clone(),
            description: "upsert_drug_interaction_errors".to_string(),
            severity: dgraph::DrugInteractionSeverity::NothingExpected,
            action: String::new(),
            reference: String::new(),
            drug_code_1: None,
        ...
        // 1. 2 drugs 1 group (should be an error)
        ...
        let input = UpsertDrugInteraction {
            ...
            action: String::new(),
            reference: String::new(),
            drug_code_1: Some("5b66ffca".to_string()),
            drug_code_2: Some("c24cdb96".to_string()),
            interaction_group_id_1: Some(new_interaction_group_id_1.clone()),
            interaction_group_id_2: None,
        };
        ...
        // 2. 1 drugs no groups (should be an error)
