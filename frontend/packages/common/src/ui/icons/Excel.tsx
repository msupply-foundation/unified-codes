...
/*
 * Excel Icon from fluentui https://developer.microsoft.com/en-us/fluentui#/styles/web/icons
 * Licence: Microsoft Fabric Assets License Agreement https://static2.sharepointonline.com/files/fabric/assets/microsoft_fabric_assets_license_agreement_nov_2019.pdf
 */
export const ExcelFileIcon = (props: SvgIconProps): JSX.Element => {
  return (
    <SvgIcon {...props} viewBox="0 0 2048 2048">
