...
export const withFlexRow = () => {
  const FlexRowContainer = React.useMemo(
    () =>
      styled(({ ...props }) => <Container {...props} />)(styles.rowContainer),
    []
  );
  const FlexChildContainer = React.useMemo(
    () =>
      styled(({ ...props }) => <Container {...props} />)(styles.childContainer),
    []
  );
  return (
    <FlexRowContainer>
...
export const withFlexColumn = () => {
  const FlexColumnContainer = React.useMemo(
    () =>
      styled(({ ...props }) => <Container {...props} />)(
